...
const  handleSubmit = async (e) => {
    ...
    if (result.code === 200) {
        setStatus({ success: true, message: 'Message sent enjoy your day'});
    } else {
                ...
                <div className="contact_content">
                    ...
                    <div className="contact_info">
                        <div className="contact_card">
                            ...
                            <a href="mailto:simonmalapane018@gmail.com" className="contact_button">Write me{" "} <i className="bx bx-right-arrow-alt contact_button-icon"></i></a>
                        </div>

                        <div className="contact_card">
                            <i className="bx bx-phone-call contact_card-icon"></i>

                            <h3 className="contact_card-title">Phone Call</h3>
                            <span className="contact_card-data">0813124016</span>

                            <a href="tel:0813124016" className="contact_button">Write me{" "} <i className="bx bx-right-arrow-alt contact_button-icon"></i></a>
                        </div>
                        ...
                        <div className="contact_card">
                            ...
                            <a href="https://www.linkedin.com/in/Simon Malesela" className="contact_button">Write me{" "} <i className="bx bx-right-arrow-alt contact_button-icon"></i></a>
                        </div>
                    </div>
                </div>
